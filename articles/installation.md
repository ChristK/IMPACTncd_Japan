...
IMPACTncd-Japan can be used in several ways depending on your needs and
technical setup.

### Option 1: Docker (Recommended)

Docker provides the most reliable and consistent experience across
...
- **Operating System**: Linux (Ubuntu 20.04+), macOS (10.15+), or
  Windows 10+
- **Memory**: Minimum 16GB RAM (32GB+ recommended for larger
  simulations)
...
- **Documentation**: Check the
  [wiki](https://github.com/ChristK/IMPACTncd_Japan/wiki)

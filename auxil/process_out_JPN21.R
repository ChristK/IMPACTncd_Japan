...
tbl_smmrs <- function(
    what = c(
            ...
            "net_qalys", "net_costs"
			, "dpp_cause_specific" #add for cause-specific DPPs
	),
    ...
    two_agegrps = FALSE # if TRUE, agegrp is 30-64 and 65-99
        ...
        str0 <- c(
                ...
                "dpp" = "mrtl",
                "pop" = "prvl"
                , "dpp_cause_specific" = "dis_mrtl" #add for cause-specific DPPs
        )
        ...
        str2 <- c(
                ...
                "dpp" = "_mrtl$",
                "pop" = "^popsize$"
                , "dpp_cause_specific" = "^nonmodelled_deaths$|^chd_deaths$|^stroke_deaths$|^popsize$" #add for cause-specific DPPs
        ) # used in grep
        ...
        str3 <- c(
                ...
                "dpp" = "dpp_",
                "pop" = "pop_size_"
                , "dpp_cause_specific" = "dpp_" #add for cause-specific DPPs
        ...
        str4 <- c(
                ...
                "pop" = "pop size by "
                , "dpp_cause_specific" = "cause-specific deaths prevented or postponed by " #add for cause-specific DPPs
        ...
        lapply(strata, function(x) {
                if (grepl("^cms_", what)) {
                        ...
                        } else if (!what %in% c("pop", "cypp", "cpp", "dpp", "dpp_cause_specific")) { # avoid calculating rates for pop, cypp, cpp, dpp, dpp_cause_specific #add for cause-specific DPPs
                        ...
                        if (grepl("^cypp$|^cpp$|^dpp$|^dpp_cause_specific$", what)) { #add for cause-specific DPPs
                                d_sc0 <- d[scenario == comparator_scenario & year >= comparison_starting_year][, scenario := NULL]
                                ...
                                d <-
                                        d[, fquantile_byid(value, prbl, id = as.character(variable), rounding = (what %in% c("pop", "cypp", "cpp", "dpp", "dpp_cause_specific"))), #add for cause-specific DPPs

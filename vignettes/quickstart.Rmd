...
- **Windows PowerShell**: [setup_user_docker_env.ps1](https://raw.githubusercontent.com/ChristK/IMPACTncd_Japan/refs/heads/main/docker_setup/setup_user_docker_env.ps1)
- **Linux/macOS**: [setup_user_docker_env.sh](https://raw.githubusercontent.com/ChristK/IMPACTncd_Japan/refs/heads/main/docker_setup/setup_user_docker_env.sh)
...
1. **Synthetic population generation**: Creates a representative population
...
- Read the [Installation Guide](installation.html) for local development setup
- Learn about [Running Simulations](running-simulations.html) in detail
- Explore [Scenario Analysis](scenario-analysis.html) for policy evaluation
